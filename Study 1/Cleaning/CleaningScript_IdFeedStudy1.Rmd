...
for(n in 1:nrow(rawFirst)){
  ...
  for(c in 1:numIdentities){
    ...
    subMatW[c,as.numeric(unlist(selectWord))]  <- (11 / 11) as.numeric ( rawFirst[n,paste0("I",c,"_Sims_",as.numeric(unlist(selectWord) ))]/11 ) # Weighted matrix
